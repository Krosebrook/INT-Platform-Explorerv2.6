...
export const strategyTiers: StrategyTier[] = [
  {
    ...
    platforms: ["claude-sonnet", "claude-opus", "chatgpt-enterprise", "github-copilot", "microsoft-copilot", "gemini-advanced", "mistral-large", "llama-3"],
  ...
  },
  {
    ...
    platforms: ["perplexity-pro", "jasper", "notion-ai", "anthropic-api", "openai-api", "aws-bedrock", "azure-openai", "grok-2", "deepseek-v3", "groq"],
